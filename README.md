...
| 模式 | 视频 | 起始 I0 | 5 分钟末 I0 | 首尾变化 | 极差 | 现象概括 |
|---|---|---:|---:|---:|---:|---|
| 九轴 | `nie_axis.mp4` | 170.8872 | 170.8856 | **-0.0016°** | **0.4797°** | 长期不漂，但有明显来回摆动，体现磁力计修正带来的波动 |
| 六轴 | `six_axis.mp4` | -0.4836 | -0.5981 | **-0.1145°** | 0.1283° | 曲线非常平滑，但存在持续单向漂移，符合纯陀螺积分特征 |
| 六轴快速启动 | `six_axis_fastboot.mp4` | -0.0788 | +0.0188 | **+0.0976°** | 0.1558° | 启动后先向负方向漂移，再反向变化，表现出快速启动零偏后台收敛过程 |
