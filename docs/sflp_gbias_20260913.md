...
src/main.c: startup acquisition and VQF initialization
```
...
```text
tools/dap_sflp_attitude.py     10 x 1 s spot attitude + GBIAS samples
tools/dap_sflp_gbias_read.py   raw gyro vs decoded SFLP GBIAS
tools/dap_sflp_diag.py         FIFO tag/level diagnostic
tools/dap_yaw_kf_compare.py     live VQF/POSE telemetry and 60 s drift report
```
